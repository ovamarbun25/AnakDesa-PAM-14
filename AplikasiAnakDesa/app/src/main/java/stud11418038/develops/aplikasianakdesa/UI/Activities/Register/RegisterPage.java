package stud11418038.develops.aplikasianakdesa.UI.Activities.Register;
...
public class RegisterPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private void userSignUp() {
        ...
        Call<DefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .createUser(nama, value, jeniskelamin, domisili,username,password);
